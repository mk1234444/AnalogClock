...
namespace Expression.Blend.DataStore.DataStore
{
	...
	public class DataStoreGlobalStorage
	{
		...
		private string _Chime = string.Empty;
		...
		public string Chime
		{
			...
			set
			{
				...
				if (this._Chime != value)
				{
					this._Chime = value;
					this.OnPropertyChanged("Chime");
				}
			}
		}
	...
	public class DataStore : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public DataStore()
		{
			try
			{
				System.Uri resourceUri = new System.Uri("/FootyScoresLayout;component/DataStore/DataStore/DataStore.xaml", System.UriKind.Relative);
		...
		public string Chime
		{
			get
			{
				return DataStoreGlobalStorage.Singleton.Chime;
			}

			set
			{
				DataStoreGlobalStorage.Singleton.Chime = value;
			}
		}
		...
		public string Rotation
		{
			get
			{
				return DataStoreGlobalStorage.Singleton.Rotation;
			}

			set
			{
				DataStoreGlobalStorage.Singleton.Rotation = value;
			}
		}
	}
}
